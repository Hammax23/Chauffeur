...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    // robotsExtraRules: keep literal (Allow:/Disallow: lines) — do not HTML-escape
    const robotsExtra =
      body.robotsExtraRules != null
        ? String(body.robotsExtraRules).trim().slice(0, 20_000) || null
        : undefined;
    ...
    const settings = await prisma.seoSettings.upsert({
      ...
      create: {
        id: "global",
        siteUrl: url("siteUrl") || "https://sarjworldwide.ca",
      ...
      update: {
        ...(url("siteUrl") !== undefined && { siteUrl: url("siteUrl") || "https://sarjworldwide.ca" }),
        ...
        ...(url("defaultOgImage") !== undefined && { defaultOgImage: url("defaultOgImage") }),
        ...
        ...(str("googleVerification") !== undefined && {
          googleVerification: str("googleVerification") || null,
        }),
        ...(str("bingVerification") !== undefined && { bingVerification: str("bingVerification") || null }),
        ...(str("yandexVerification") !== undefined && {
          yandexVerification: str("yandexVerification") || null,
        }),
        ...(str("pinterestVerification") !== undefined && {
          pinterestVerification: str("pinterestVerification") || null,
        }),
        ...
        ...(str("organizationName") !== undefined && {
          organizationName: str("organizationName") || null,
        }),
        ...(url("organizationLogo") !== undefined && { organizationLogo: url("organizationLogo") }),
        ...(str("organizationPhone") !== undefined && {
          organizationPhone: str("organizationPhone") || null,
        }),
        ...(str("organizationEmail") !== undefined && {
          organizationEmail: str("organizationEmail") || null,
        }),
        ...(str("organizationAddress") !== undefined && {
          organizationAddress: str("organizationAddress") || null,
        }),
        ...(str("organizationCity") !== undefined && {
          organizationCity: str("organizationCity") || null,
        }),
        ...(str("organizationRegion") !== undefined && {
          organizationRegion: str("organizationRegion") || null,
        }),
        ...(str("organizationPostal") !== undefined && {
          organizationPostal: str("organizationPostal") || null,
        }),
        ...(str("organizationCountry") !== undefined && {
          organizationCountry: str("organizationCountry") || "CA",
        }),
        ...
        ...(robotsExtra !== undefined && { robotsExtraRules: robotsExtra }),
    ...
    const hint =
      msg.includes("does not exist") || msg.includes("SeoSettings")
