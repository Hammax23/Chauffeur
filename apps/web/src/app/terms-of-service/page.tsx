        ...
        <div className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-gray max-w-none space-y-10">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-600 text-[15px] leading-relaxed space-y-1.5 ml-4 mb-3">
                <li>Phone: <span className="text-[#C9A063]">+1 (416) 893-5779</span></li>
                <li>Text: <a href="sms:+14168935779" className="text-[#C9A063] hover:underline">+1 (416) 893-5779</a></li>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-100">
              ...
              <div className="space-y-2 text-[15px]">
                ...
                <p className="text-gray-600">Phone: <span className="text-[#C9A063]">+1 (416) 893-5779</span></p>
                <p className="text-gray-600">Text: <a href="sms:+14168935779" className="text-[#C9A063] hover:underline">+1 (416) 893-5779</a></p>
