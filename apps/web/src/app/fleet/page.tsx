...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata("/fleet", {
    title: "Our Fleet | SARJ Worldwide Chauffeur Services",
    description: "SARJ Worldwide chauffeur fleet: Mercedes-Benz, BMW, Cadillac, Range Rover & more. Executive sedans, SUVs, premium vans for every chauffeur occasion.",
