        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {displayedServices.map((service) => {
            ...
            return (
              <div
                key={service.slug}
                className="group rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 relative flex flex-col h-[400px] sm:h-[450px] overflow-hidden cursor-pointer"
              >
                ...
                <div className="relative z-10 flex flex-col justify-end h-full p-6 sm:p-8">
                  ...
                  <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center mb-4 border border-white/20 group-hover:bg-[#C9A063]/20 group-hover:border-[#C9A063]/40 transition-all duration-300">
                    {IconComponent && (
                      <IconComponent className="w-5 h-5 text-[#C9A063]" strokeWidth={1.5} />
                    )}
                  </div>

                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-[#C9A063] transition-colors duration-300">
                    {service.title}
                  </h3>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-[13px] font-semibold text-[#C9A063] uppercase tracking-wider hover:text-white transition-colors w-fit"
                  >
                    Learn More
                    <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" strokeWidth={2} />
                  </Link>
                </div>
              </div>
            );
