...
const fleetData = [
  ...
  { name: 'CADILLAC LYRIQ', images: ['/fleet/lyricfront.png', '/fleet/lyric.png', '/fleet/lyric2.png', '/fleet/lyricinterior.jpg'], seating: '4 maximum, 4 comfortable', luggage: '2 large, 2 medium' },
