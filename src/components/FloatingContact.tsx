    ...
    <div className="fixed bottom-6 right-6 z-[45] flex flex-col items-end gap-3">
      ...
      >
        <a
          ...
          className="group flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40 hover:shadow-xl hover:shadow-[#25D366]/50 hover:scale-110 active:scale-95 transition-all duration-200"
        ...
        <a
          ...
          className="group flex items-center justify-center w-14 h-14 rounded-full bg-gray-900 text-white shadow-lg shadow-black/20 hover:bg-[#C9A063] hover:shadow-[#C9A063]/40 hover:scale-110 active:scale-95 transition-all duration-200"
